...
exports.sendTicketStatusChangeEmail = sendTicketStatusChangeEmail;
// lib/services/email-notification.ts
const mailer_1 = require("@/lib/mailer");
async function sendTicketAssignmentEmail(assigneeEmail, assigneeName, ticketTitle, ticketId, clientName, priority, dueDate) {
...
Bhavya Enterprises CRM
  `;
    try {
        ...
        console.error(`Failed to send assignment email to ${assigneeEmail}:`, error);
        throw error;
    }
}
async function sendTicketStatusChangeEmail(assigneeEmail, assigneeName, ticketTitle, ticketId, oldStatus, newStatus) {
...
Bhavya Enterprises CRM
  `;
    try {
        ...
        console.error(`Failed to send status change email to ${assigneeEmail}:`, error);
        throw error;
    }
}
